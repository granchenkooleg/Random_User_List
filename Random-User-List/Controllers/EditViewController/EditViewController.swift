...
class EditViewController: UIViewController, UITextFieldDelegate, AlertDisplayer {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if (imageView != nil) {
            editImageView.sd_setImage(with: URL(string: (imageView)))
        } else {
        editImageView.sd_setImage(with: URL(string: (dataSavedUser?.thumbnail ?? dataOfUser?.thumbnail)!))
        }
    }
...
extension EditViewController: UIImagePickerControllerDelegate, UINavigationControllerDelegate  {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : Any]) {
        ...
        imageView = photoURL.absoluteString
